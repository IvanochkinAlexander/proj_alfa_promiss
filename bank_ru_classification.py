...
def make_submission (preds_all, source_test):
    ...
    for i in preds_all['clf'].unique():
        ...
        try:
            ...
            pass
    submission.to_excel('../output/promiss/submisssion_bank{}.xlsx'.format(i), index=False)
    return submission
...
def split_test (path_test):
    ...
    all_dfs_input.to_excel('../output/promiss/temp_input.xlsx', index=False)
...
paths_train =  ['~/portia_projects/output_data/',]
path_test = '/root/portia_projects/output_data/bank_ru_processed.xlsx'

num_parts = split_test(path_test)
...
for i in range(int(num_parts)):
    ...
    train_path = '../input/06_07_09_train.xlsx'
    # train_path = 'input/train_sent.xlsx'
    # test_path = '../output/promiss/test.xlsx'
